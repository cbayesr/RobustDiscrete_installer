...
From Appendix C of Bayes, Bazán, and Valdvieso (2024). Estimation of model M5 had a run time of 212 seconds on an Intel Core i-7 processor with 2.80 GHz and 16.0 GB RAM due to the use of numerical integration to evaluate the probability mass function of the B2B distribution.
